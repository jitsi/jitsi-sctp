    ...
    implements SctpDataSender
{
     ...
     * The logger.
     */
//    private final static Logger logger = Logger.getLogger(org.jitsi.sctp4j.SctpSocket.class);
...
//                }
     ...
     * @throws IOException if this socket is closed or an error occurs
...
//                        e);
    ...
    public interface NotificationListener
    {
         ...
         * Fired when usrsctp stack sends notification.
         *
         * @param socket the {@link org.jitsi_modified.sctp4j.SctpSocket} notification source.
         * @param notification the <tt>SctpNotification</tt> triggered.
         */
        public void onSctpNotification(
                SctpSocket socket,
